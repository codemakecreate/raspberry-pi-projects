...
# num = [0xc0, 0xf9, 0xa4, 0xb0, 0x99, 0x92, 0x82, 0xf8, 0x80, 0x90, 0x88, 0x83, 0xc6, 0x86, 0x8e]
# 
# for i in range(0,len(num)):
#     latchPin.off()
#     shiftOut(MSFIRST, num[i]) #Output the figures and he highest level is transferred preferentially
#     latchPin.on()
#     time.sleep(0.5)
#     shiftOut(MSFIRST, num[i]&0x7f) #use "&0x7f" to display the decimal point
#         
